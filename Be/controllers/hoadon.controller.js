...
exports.getById = async (req, res) => {
    try {
        const data = await Hoadon.getById(req.params.id);
...
exports.create = async (req, res) => {
    try {
        const result = await Hoadon.create(req.body);
...
exports.update = async (req, res) => {
    try {
        const result = await Hoadon.update(req.params.id, req.body);
...
exports.search = async (req, res) => {
    try {
        ...
        const data = await Hoadon.search(keyword);
        res.json({ success: true, data });
    } catch (error) {
        res.status(500).json({ success: false, message: error.message });
    }
