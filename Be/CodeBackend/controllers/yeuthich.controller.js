...
exports.getAll = async (req, res) => {
    try {
        const data = await Yeuthich.getAll();
...
exports.getById = async (req, res) => {
    try {
        const data = await Yeuthich.getById(req.params.id);
...
exports.create = async (req, res) => {
    try {
        const result = await Yeuthich.create(req.body);
...
exports.update = async (req, res) => {
    try {
        const result = await Yeuthich.update(req.params.id, req.body);
...
exports.remove = async (req, res) => {
    try {
        const result = await Yeuthich.delete(req.params.id);
        if (!result.affectedRows) return res.status(404).json({ success: false, message: 'Không tìm thấy dữ liệu' });
